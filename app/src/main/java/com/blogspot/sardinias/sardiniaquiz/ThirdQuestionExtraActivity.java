...
public class ThirdQuestionExtraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_question_extra);
    ...
    public void nextButton(View view) {
        ...
        Intent nextIntent = new Intent(ThirdQuestionExtraActivity.this, FourthQuestionActivity.class);
