...
public class FifthQuestionActivity extends AppCompatActivity {
    ...
    public void nextButton(View view) {
        ...
        // Get the first and third checkbox state
        CheckBox autunnoInBarbagia = findViewById(R.id.autunno_in_barbagia);
        CheckBox primaveraInGallura = findViewById(R.id.primavera_in_gallura);

        if (autunnoInBarbagia.isChecked() & primaveraInGallura.isChecked()) {
            score++;
        }

        // Create an Intent for next activity
        Intent nextIntent = new Intent(FifthQuestionActivity.this, SixthQuestionActivity.class);
