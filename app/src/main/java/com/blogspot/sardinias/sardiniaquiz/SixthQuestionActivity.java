...
public class SixthQuestionActivity extends AppCompatActivity {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (rb.getId()) {
                    case R.id.answer1_text:
                        score++;
                        Toast.makeText(SixthQuestionActivity.this, "Correct! Keep going!", Toast.LENGTH_SHORT).show();
                        break;
    ...
    public void nextButton(View view) {
        ...
        Intent nextIntent = new Intent(SixthQuestionActivity.this, SeventhQuestionActivity.class);
