...
public class NinthQuestionActivity extends AppCompatActivity {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (rb.getId()) {
                    ...
                    case R.id.answer2_text:
                        score++;
                        Toast.makeText(NinthQuestionActivity.this, "Correct! Keep going!", Toast.LENGTH_SHORT).show();
                        break;
    ...
    public void nextButton(View view) {
        ...
        Intent nextIntent = new Intent(NinthQuestionActivity.this, TenthQuestionActivity.class);
